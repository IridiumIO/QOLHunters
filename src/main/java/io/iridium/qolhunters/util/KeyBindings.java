...
public class KeyBindings {
    ...
    public static final String KEY_TOGGLE_ELYRA = "key.qolhunters.toggle_elytra";
    ...
    public static final KeyMapping TOGGLE_ELYTRA = new KeyMapping(KEY_TOGGLE_ELYRA, KeyConflictContext.IN_GAME, KeyModifier.NONE, InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_UNKNOWN, KEY_CATEGORY);
